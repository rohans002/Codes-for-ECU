...
/*******************************************************************************
 * flexTimer_pwm_2 initialization code
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
- name: 'flexTimer_pwm_2'
- type: 'flexTimer_pwm'
- mode: 'general'
...
/* Global configuration of flexTimer_pwm_2 InitConfig */
ftm_user_config_t flexTimer_pwm_2_InitConfig =
{
    {
...
/* Fault configuration structure for flexTimer_pwm_2*/
ftm_pwm_fault_param_t flexTimer_pwm_2_FaultConfig =
{
...
ftm_independent_ch_param_t flexTimer_pwm_2_IndependentChannelsConfig[3] =
{
    {
