...
/*******************************************************************************
 * flexTimer_pwm_0 initialization code
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
- name: 'flexTimer_pwm_0'
- type: 'flexTimer_pwm'
- mode: 'general'
        ...
        - FtmPwmConfigArr:
          ...
          - ftmPwmIndptChnCfg:
            - pwmIndependentChannelConfig:
              - 0:
                - ftmpwmIndptName: 'flexTimer_pwm_0_IndependentChannelConfig0'
              ...
              - 1:
                - ftmpwmIndptName: 'flexTimer_pwm_0_IndependentChannelConfig1'
                ...
                - IndptdeadTimeEn: 'false'
              - 2:
                - ftmpwmIndptName: 'flexTimer_pwm_0_IndependentChannelConfig2'
...
/* Global configuration of flexTimer_pwm_0 InitConfig */
ftm_user_config_t flexTimer_pwm_0_InitConfig =
{
    {
...
/* Fault configuration structure for flexTimer_pwm_0*/
ftm_pwm_fault_param_t flexTimer_pwm_0_FaultConfig =
{
...
/* The independent channels configuration structure for flexTimer_pwm_0_IndependentChannelsConfig */
ftm_independent_ch_param_t flexTimer_pwm_0_IndependentChannelsConfig[3] =
{
    {
...
/* PWM configuration for flexTimer_pwm_0 */
ftm_pwm_param_t flexTimer_pwm_0_PwmConfig =
{
    ...
    1000U, /* PWM frequency */
    flexTimer_pwm_0_IndependentChannelsConfig, /* The independent PWM channels configuration structure */
    NULL, /* Combined PWM channels configuration structure */
    &flexTimer_pwm_0_FaultConfig /* PWM fault configuration structure */
};
