...
/*******************************************************************************
 * terminal_screen initialization code
 ******************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
...
- config_sets:
  - lpuart_driver:
    ...
    - lpuart_configuration:
      - 0:
        - name: 'terminal_screen_InitConfig'
        - readonly: 'true'
 ...
 *
 */
lpuart_state_t terminal_screen_state;

const lpuart_user_config_t terminal_screen_InitConfig = {
  .transferType = LPUART_USING_INTERRUPTS,
  .baudRate = 9600UL,
  .parityMode = LPUART_PARITY_DISABLED,
  .stopBitCount = LPUART_ONE_STOP_BIT,
